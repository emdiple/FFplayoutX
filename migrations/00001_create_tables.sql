...
CREATE TABLE
    global (
        ...
        advendor_base_url TEXT NOT NULL DEFAULT "http://0.0.0.0:8008",
...
CREATE TABLE
    channels (
        ...
        public TEXT NOT NULL DEFAULT "/usr/share/ffplayout/public",
        playlists TEXT NOT NULL DEFAULT "/var/lib/ffplayout/playlists",
        advendor_base_url TEXT NOT NULL DEFAULT "http://",
        is_advendor_nownext BOOLEAN NOT NULL DEFAULT FALSE,
        advendor_nownext_route TEXT NOT NULL DEFAULT "",
        storage TEXT NOT NULL DEFAULT "/var/lib/ffplayout/tv-media",
        last_date TEXT,
